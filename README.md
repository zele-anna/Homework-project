...
### Запуск программы
Программа предлагает пользователю выбрать опции выбору источника данных, а также фильтрации и сортировке списка 
транзакций и выводит общую информацию об операциях, попадающих под введенные критерии.
...
9. Функции поиска транзакций по описанию транзакций (ключ description) и подсчета количества транзакций в переданном 
списке транзакций по переданным категориям (описанию по ключу description).
...
* В модуле [test_search.py](tests/test_search.py) содержатся тесты на фильтрацию транзакций из переданного списка по
переданной строке, а также функции подсчета количества транзакций по описанию из переданного списка категорий.